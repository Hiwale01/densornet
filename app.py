...
def load_model(path):
    ...
    xception_model = tf.keras.models.Sequential([
        ...
        tf.keras.layers.Dense(38, activation='softmax')  # Update to match your number of classes
    ])
...
# Loading the Model
model = load_model('C:\\Users\\Soham Sarwadhikari\\Desktop\\Ayush project\\model.h5')
